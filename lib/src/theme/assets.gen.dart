...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/icon_speak.svg
  SvgGenImage get iconSpeak => const SvgGenImage('assets/icons/icon_speak.svg');
...
class $AssetsImagesOnboardingGen {
  ...
  /// File path: assets/images/onboarding/bgr_1.png
  AssetGenImage get bgr1 =>
      const AssetGenImage('assets/images/onboarding/bgr_1.png');

  /// File path: assets/images/onboarding/bgr_2.png
  AssetGenImage get bgr2 =>
      const AssetGenImage('assets/images/onboarding/bgr_2.png');

  /// File path: assets/images/onboarding/bgr_3.png
  AssetGenImage get bgr3 =>
      const AssetGenImage('assets/images/onboarding/bgr_3.png');
