...
import 'package:demo_dprofiles/src/features/AI/create_digital_profile/presentation/pages/create_dprofile_success_page.dart'
    as _i7;
import 'package:demo_dprofiles/src/features/AI/write_cover_letter/presentation/pages/write_cover_letter_page.dart'
    as _i20;
import 'package:demo_dprofiles/src/features/AI/write_interview_question/presentation/pages/write_interview_question_page.dart'
    as _i21;
import 'package:demo_dprofiles/src/features/AI/write_profile_introduction/presentation/pages/write_profile_introduction_page.dart'
    as _i22;
import 'package:demo_dprofiles/src/features/AI/write_skill_knowledge/presentation/pages/write_skill_knowledge.dart'
    as _i23;
...
abstract class $AppRouter extends _i24.RootStackRouter {
  ...
  final Map<String, _i24.PageFactory> pagesMap = {
    ...
    WriteCoverLetterRoute.name: (routeData) {
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i20.WriteCoverLetterPage(),
      );
    },
    WriteInterviewQuestionRoute.name: (routeData) {
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i21.WriteInterviewQuestionPage(),
      );
    },
    WriteProfileIntroductionRoute.name: (routeData) {
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i22.WriteProfileIntroductionPage(),
      );
    },
    WriteSkillKnowledgeRoute.name: (routeData) {
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i23.WriteSkillKnowledgePage(),
      );
    },
  };
}
...
/// generated route for
/// [_i1.AICharacterPage]
class AICharacterRoute extends _i24.PageRouteInfo<void> {
  const AICharacterRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i3.AuthGatePage]
class AuthGateRoute extends _i24.PageRouteInfo<AuthGateRouteArgs> {
  AuthGateRoute({
    _i25.Key? key,
  ...
  static const _i24.PageInfo<AuthGateRouteArgs> page =
      _i24.PageInfo<AuthGateRouteArgs>(name);
}
...
class ConnectWalletRoute extends _i24.PageRouteInfo<void> {
  const ConnectWalletRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
class CreateAnAccountRoute
    extends _i24.PageRouteInfo<CreateAnAccountRouteArgs> {
  ...
  static const _i24.PageInfo<CreateAnAccountRouteArgs> page =
      _i24.PageInfo<CreateAnAccountRouteArgs>(name);
}
...
class CreateDigitalProfileRoute extends _i24.PageRouteInfo<void> {
  const CreateDigitalProfileRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
class CreateDigitalProfileSuccessRoute extends _i24.PageRouteInfo<void> {
  const CreateDigitalProfileSuccessRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
class MyAICharacterRoute extends _i24.PageRouteInfo<void> {
  const MyAICharacterRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i13.OpenToWorkPage]
class OpenToWorkRoute extends _i24.PageRouteInfo<void> {
  const OpenToWorkRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
class SignUpSuccessRoute extends _i24.PageRouteInfo<void> {
  const SignUpSuccessRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
class UpdateNewPasswordRoute extends _i24.PageRouteInfo<void> {
  const UpdateNewPasswordRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
class VerifyEmailForgotPasswordRoute extends _i24.PageRouteInfo<void> {
  const VerifyEmailForgotPasswordRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
class VerifySignUpRoute extends _i24.PageRouteInfo<VerifySignUpRouteArgs> {
  VerifySignUpRoute({
    _i25.Key? key,
    required String email,
    List<_i24.PageRouteInfo>? children,
  ...
  static const _i24.PageInfo<VerifySignUpRouteArgs> page =
      _i24.PageInfo<VerifySignUpRouteArgs>(name);
}
...
/// generated route for
/// [_i20.WriteCoverLetterPage]
class WriteCoverLetterRoute extends _i24.PageRouteInfo<void> {
  const WriteCoverLetterRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i21.WriteInterviewQuestionPage]
class WriteInterviewQuestionRoute extends _i24.PageRouteInfo<void> {
  const WriteInterviewQuestionRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i22.WriteProfileIntroductionPage]
class WriteProfileIntroductionRoute extends _i24.PageRouteInfo<void> {
  const WriteProfileIntroductionRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i23.WriteSkillKnowledgePage]
class WriteSkillKnowledgeRoute extends _i24.PageRouteInfo<void> {
  const WriteSkillKnowledgeRoute({List<_i24.PageRouteInfo>? children})
      : super(
