      ...
      child: IgnorePointer(
        ...
        child: TabBar(
          ...
          tabs: [
            ...
            Tuple2(CreateAICharacterStep.trainingAI, () {}),
...
enum CreateAICharacterStep { basicInfo, profiles, character, trainingAI }
...
extension CreateCharacterStepExt on CreateAICharacterStep {
  String get title {
    return switch (this) {
      ...
      CreateAICharacterStep.trainingAI => 'Training AI',
    };
  }
  ...
  int get position {
    return switch (this) {
      ...
      CreateAICharacterStep.trainingAI => 4,
    };
  }
}
