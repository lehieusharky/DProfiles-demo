...
class CoverLetterResult extends StatefulWidget {
  const CoverLetterResult({Key? key}) : super(key: key);

  @override
  State<CoverLetterResult> createState() =>
      _CoverLetterResultState();
}

class _CoverLetterResultState extends State<CoverLetterResult> {
  late FlutterTts tts;
