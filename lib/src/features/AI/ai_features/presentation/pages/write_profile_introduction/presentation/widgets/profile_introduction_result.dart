...
class ProfileIntroductionResult extends StatefulWidget {
  const ProfileIntroductionResult({Key? key}) : super(key: key);

  @override
  State<ProfileIntroductionResult> createState() =>
      _ProfileIntroductionResultState();
}

class _ProfileIntroductionResultState extends State<ProfileIntroductionResult> {
  late FlutterTts tts;
