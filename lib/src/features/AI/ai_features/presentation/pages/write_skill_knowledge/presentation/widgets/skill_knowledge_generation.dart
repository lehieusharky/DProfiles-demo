...
class SkillKnowledgeGeneration extends StatefulWidget {
  const SkillKnowledgeGeneration({Key? key}) : super(key: key);

  @override
  State<SkillKnowledgeGeneration> createState() =>
      _SkillKnowledgeGenerationState();
}

class _SkillKnowledgeGenerationState
    extends State<SkillKnowledgeGeneration> {
