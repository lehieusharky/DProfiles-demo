...
class _$UserSkillModelImpl implements _UserSkillModel {
  ...
  @override
  String toString() {
    return 'UserSkillModel(id: $id, userId: $userId, skillId: $skillId, level: $level, updatedOn: $updatedOn, order: $order, updatedTs: $updatedTs, createdTs: $createdTs, skill: $skill)';
  }
...
abstract class _UserSkillModel implements UserSkillModel {
  const factory _UserSkillModel(
      ...
      final Skill? skill}) = _$UserSkillModelImpl;
