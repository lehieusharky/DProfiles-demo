...
import '../../features/blogs/data/datasources/blog_datasource.dart' as _i49;
...
import '../../features/blogs/data/repositories_impl/blog_repository_impl.dart'
    as _i52;
import '../../features/blogs/domain/repositories/blog_repository.dart' as _i51;
...
import '../../features/blogs/domain/usecases/fetch_all_blogs_usecase_impl.dart'
    as _i54;
import '../../features/home/data/datasources/home_datasource_impl.dart' as _i32;
import '../../features/home/data/datasources/home_datasources.dart' as _i31;
...
import '../../features/home/domain/usecases/home_usecase.dart' as _i35;
import '../../features/profile/data/datasoures/profile_datasource.dart' as _i36;
...
import '../../features/profile/domain/repositories/profile_repository.dart'
    as _i38;
import '../../features/profile/domain/usecases/profile_usecase.dart' as _i40;
...
import '../../features/setting/domain/repositories/setting_repository.dart'
    as _i44;
import '../../features/setting/domain/usecases/setting_usecase.dart' as _i46;
import '../../utils/data/cache/app_share_preference.dart' as _i8;
import '../../utils/data/cache/app_share_preference_impl.dart' as _i9;
import '../../utils/https/dio/app_rest_client.dart' as _i41;
import '../../utils/services/strapi/strapi_dio_client.dart' as _i55;
import '../../utils/services/strapi/strapi_service.dart' as _i48;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i31.HomeDataSource>(() => _i32.HomeDataSourceIml());
  gh.factory<_i33.HomeRepository>(
      () => _i34.HomeRepositoryImpl(gh<_i31.HomeDataSource>()));
  gh.factory<_i35.HomeUseCase>(
      () => _i35.HomeUseCaseImpl(gh<_i33.HomeRepository>()));
  gh.factory<_i36.ProfileDataSource>(() => _i37.ProfileDataSourceImpl());
  gh.factory<_i38.ProfileRepository>(
      () => _i39.ProfileRepositoryImpl(gh<_i36.ProfileDataSource>()));
  gh.factory<_i40.ProfileUseCase>(
      () => _i40.ProfileUseCaseImpl(gh<_i38.ProfileRepository>()));
  gh.factory<_i41.RestClient>(() => appModule.restClient);
  gh.factory<_i42.SettingDataSource>(() => _i43.SettingDataSourceImpl());
  gh.factory<_i44.SettingRepository>(
      () => _i45.SettingRepositoryImpl(gh<_i42.SettingDataSource>()));
  gh.factory<_i46.SettingUseCase>(
      () => _i46.SettingUseCaseImpl(gh<_i44.SettingRepository>()));
  await gh.factoryAsync<_i47.SharedPreferences>(
    () => appModule.sharedPreferences,
    preResolve: true,
  );
  gh.factory<_i48.StrapiService>(
      () => _i48.StrapiService(gh<_i30.Dio>(instanceName: 'strapi')));
  gh.factory<_i49.BlogDataSource>(
      () => _i50.BlogDataSourceImpl(gh<_i48.StrapiService>()));
  gh.factory<_i51.BlogRepository>(
      () => _i52.BlogRepositoryImpl(gh<_i49.BlogDataSource>()));
  gh.factory<_i53.FetchAllBlogsUseCase>(
      () => _i54.FetchAllBlogsUseCaseImpl(gh<_i51.BlogRepository>()));
  return getIt;
}

class _$StrapiModule extends _i55.StrapiModule {}
