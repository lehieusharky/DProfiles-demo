...
import '../../features/auth/presentation/pages/forgot_password/domain/repositories/forgot_password_repository.dart'
    as _i33;
import '../../features/blogs/data/datasources/blog_datasource.dart' as _i53;
...
import '../../features/blogs/data/repositories_impl/blog_repository_impl.dart'
    as _i56;
import '../../features/blogs/domain/repositories/blog_repository.dart' as _i55;
...
import '../../features/blogs/domain/usecases/fetch_all_blogs_usecase_impl.dart'
    as _i58;
import '../../features/home/data/datasources/home_datasource_impl.dart' as _i36;
import '../../features/home/data/datasources/home_datasources.dart' as _i35;
...
import '../../features/home/domain/usecases/home_usecase.dart' as _i39;
import '../../features/profile/data/datasoures/profile_datasource.dart' as _i40;
...
import '../../features/setting/domain/repositories/setting_repository.dart'
    as _i48;
import '../../features/setting/domain/usecases/setting_usecase.dart' as _i50;
import '../../utils/data/cache/app_share_preference.dart' as _i8;
import '../../utils/data/cache/app_share_preference_impl.dart' as _i9;
import '../../utils/https/dio/app_rest_client.dart' as _i45;
import '../../utils/services/strapi/strapi_dio_client.dart' as _i59;
import '../../utils/services/strapi/strapi_service.dart' as _i52;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i31.ForgotPasswordDataSource>(
      () => _i32.ForgotPasswordDataSourceIml());
  gh.factory<_i33.ForgotPasswordRepository>(() =>
      _i34.ForgotPasswordRepositoryImpl(gh<_i31.ForgotPasswordDataSource>()));
  gh.factory<_i35.HomeDataSource>(() => _i36.HomeDataSourceIml());
  gh.factory<_i37.HomeRepository>(
      () => _i38.HomeRepositoryImpl(gh<_i35.HomeDataSource>()));
  gh.factory<_i39.HomeUseCase>(
      () => _i39.HomeUseCaseImpl(gh<_i37.HomeRepository>()));
  gh.factory<_i40.ProfileDataSource>(() => _i41.ProfileDataSourceImpl());
  gh.factory<_i42.ProfileRepository>(
      () => _i43.ProfileRepositoryImpl(gh<_i40.ProfileDataSource>()));
  gh.factory<_i44.ProfileUseCase>(
      () => _i44.ProfileUseCaseImpl(gh<_i42.ProfileRepository>()));
  gh.factory<_i45.RestClient>(() => appModule.restClient);
  gh.factory<_i46.SettingDataSource>(() => _i47.SettingDataSourceImpl());
  gh.factory<_i48.SettingRepository>(
      () => _i49.SettingRepositoryImpl(gh<_i46.SettingDataSource>()));
  gh.factory<_i50.SettingUseCase>(
      () => _i50.SettingUseCaseImpl(gh<_i48.SettingRepository>()));
  await gh.factoryAsync<_i51.SharedPreferences>(
    () => appModule.sharedPreferences,
    preResolve: true,
  );
  gh.factory<_i52.StrapiService>(
      () => _i52.StrapiService(gh<_i30.Dio>(instanceName: 'strapi')));
  gh.factory<_i53.BlogDataSource>(
      () => _i54.BlogDataSourceImpl(gh<_i52.StrapiService>()));
  gh.factory<_i55.BlogRepository>(
      () => _i56.BlogRepositoryImpl(gh<_i53.BlogDataSource>()));
  gh.factory<_i57.FetchAllBlogsUseCase>(
      () => _i58.FetchAllBlogsUseCaseImpl(gh<_i55.BlogRepository>()));
  return getIt;
}

class _$StrapiModule extends _i59.StrapiModule {}
